...
def train_model(data: pd.DataFrame, target_var: str, initial_features: typing.List[str],
    ...
    try:
        ...
        logger.warning("Invalid test_size. Received %f but test size should be in (0,1). Setting " +
    ...
    try:
        ...
        logger.info("Splitting features and target into train and test. Test size = %0.2f%%",
                    test_size*100)
    ...
    try: 
        ...
        logger.info("Cross-validation completed. Best parameters found: %s ",
                    grid_search.bets_params_)
